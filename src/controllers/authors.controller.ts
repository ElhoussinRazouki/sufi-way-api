...
export const listController = async (req: Request, res: Response) => {
    ...
    AuthorService.list(filters).then((result) => {
...
export const detailsController = async (req: Request, res: Response) => {
    ...
    AuthorService.details(id).then((result) => {
...
export const createController = async (req: Request, res: Response) => {
    ...
    AuthorService.create(payload).then((created) => {
...
export const updateController = async (req: Request, res: Response) => {
    const id = req.params.id;
    const payload = req.body;
    AuthorService.update(id, payload).then((updated) => {
...
export const RemoveController = async (req: Request, res: Response) => {
    const id = req.params.id;
    AuthorService.remove(id).then((removed) => {
